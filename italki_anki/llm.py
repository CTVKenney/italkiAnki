...
def build_openai_payload(lines: Sequence[str], model: str, seed: int | None) -> dict:
    system_prompt = (
        ...
        "chat small talk. Exclude overly basic greetings/salutations (for "
        "example hello/ni hao/你好/你好吗) unless the user explicitly requests "
        "beginner basics. If uncertain, omit the item. For concrete countable "
